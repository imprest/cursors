defmodule MousersWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MousersWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MousersWeb.Gettext, "errors", msg, opts)
    end
  end
