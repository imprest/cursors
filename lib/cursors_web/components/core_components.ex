defmodule CursorsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(CursorsWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(CursorsWeb.Gettext, "errors", msg, opts)
    # end
